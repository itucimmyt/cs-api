...
//  Created on:      10-Sep-2020 10:44:00 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 10-Sep-2020 10:44:00 PM
 */
@Component @Validated
public class MutationResolver implements GraphQLMutationResolver {
	 ...
	 */
	@Autowired
	public MutationResolver(NumberSequenceRuleSegmentService numbersequencerulesegmentService, RequestService requestService, HtmlTagService htmltagService, InstanceService instanceService, LanguageService languageService, NotificationService notificationService, EmailTemplateService emailtemplateService, NumberSequenceRuleService numbersequenceruleService, DonorService donorService, OrganizationService organizationService, TraitService traitService, PersonService personService, ProcessService processService, ProgramService programService, ProjectService projectService, ModuleService moduleService, AuthenticationTypeService authenticationtypeService, WorkflowStatusTypeService workflowstatustypeService, ActionService actionService, AddressService addressService, AlertService alertService, AlertRuleService alertruleService, EntityReferenceService entityreferenceService, AuditLogsService auditlogsService, PreferenceService preferenceService, CollaboratorService collaboratorService, ComponentService componentService, CountryService countryService, CropService cropService, CustomerService customerService, DelegationService delegationService, AttributesService attributesService, MarkerService markerService, WorkflowNodeCFService workflownodecfService, WorkflowPhaseService workflowphaseService, WorkflowStageService workflowstageService, RoleService roleService, TraitClassService traitclassService, PartnerService partnerService, WorkflowNodeService workflownodeService, DataFormatService dataformatService, WorkflowStatusService workflowstatusService, MarkerSynonymService markersynonymService, PurposeService purposeService, ServiceService serviceService, ServiceProviderService serviceproviderService, ServiceTypeService servicetypeService, TechnologyPlatformService technologyplatformService, AssayGeneService assaygeneService, SessionService sessionService, RoleActionService roleactionService, AssayclassService assayclassService, SegmentService segmentService, WorkflowInstanceService workflowinstanceService, StyleThemeService stylethemeService, TeamService teamService, TenantService tenantService, UserService userService, VendorService vendorService, SeasonService seasonService, WorkflowService workflowService, WorkflowCFTypeService workflowcftypeService, WorkflowCFValueService workflowcfvalueService, WorkflowEventService workfloweventService, TranslationService translationService){
