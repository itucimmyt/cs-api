...
public class MutationResolver implements GraphQLMutationResolver {
	 ...
	 */
	@Autowired
	public MutationResolver(AuthenticationTypeService authenticationtypeService, CountryService countryService, InstanceService instanceService, ComponentService componentService, DelegationService delegationService, ActionService actionService, ModuleService moduleService, CustomerService customerService, OrganizationService organizationService, TenantService tenantService, UserService userService, PearsonService pearsonService, AddressService addressService, SessionService sessionService, WorkflowService workflowService, LanguageService languageService, CollaboratorService collaboratorService, PartnerService partnerService, ThemeStyleService themestyleService, RoleService roleService, TranslationService translationService, WorkflowNodeService workflownodeService, DonorService donorService, AuditLogsService auditlogsService, ProcessService processService, PreferenceService preferenceService, AlertRuleService alertruleService, AlertService alertService, MessageService messageService, HtmlTagService htmltagService){
