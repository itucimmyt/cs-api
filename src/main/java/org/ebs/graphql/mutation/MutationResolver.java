...
//  Created on:      20-Aug-2020 1:05:58 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 20-Aug-2020 1:05:58 PM
 */
@Component @Validated
public class MutationResolver implements GraphQLMutationResolver {
	 ...
	 */
	@Autowired
	public MutationResolver(TeamService teamService, WorkflowCFValueService workflowcfvalueService, WorkflowCFTypeService workflowcftypeService, WorkflowService workflowService, VendorService vendorService, UserService userService, NumberSequenceRuleService numbersequenceruleService, TenantService tenantService, WorkflowPhaseService workflowphaseService, StyleThemeService stylethemeService, SessionService sessionService, SegmentService segmentService, SeasonService seasonService, RoleActionService roleactionService, RoleService roleService, TranslationService translationService, DataFormatService dataformatService, TraitService traitService, TechnologyPlatformService technologyplatformService, ServiceTypeService servicetypeService, ServiceProviderService serviceproviderService, ServiceService serviceService, PurposeService purposeService, WorkflowInstanceService workflowinstanceService, MarkerService markerService, WorkflowNodeCFService workflownodecfService, AssayGeneService assaygeneService, AssayclassService assayclassService, TraitClassService traitclassService, WorkflowStatusService workflowstatusService, WorkflowStageService workflowstageService, WorkflowEventService workfloweventService, MarkerSynonymService markersynonymService, ProjectService projectService, AttributesService attributesService, AlertRuleService alertruleService, AlertService alertService, AddressService addressService, ActionService actionService, ModuleService moduleService, RequestService requestService, WorkflowNodeService workflownodeService, ProgramService programService, ProcessService processService, PreferenceService preferenceService, PersonService personService, PartnerService partnerService, OrganizationService organizationService, WorkflowStatusTypeService workflowstatustypeService, CustomerService customerService, MessageService messageService, LanguageService languageService, InstanceService instanceService, HtmlTagService htmltagService, EntityReferenceService entityreferenceService, EmailTemplateService emailtemplateService, DelegationService delegationService, AuditLogsService auditlogsService, CropService cropService, CountryService countryService, ComponentService componentService, CollaboratorService collaboratorService, AuthenticationTypeService authenticationtypeService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, DonorService donorService){
