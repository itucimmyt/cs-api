...
//  Created on:      15-Jun-2020 5:13:50 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 15-Jun-2020 5:13:50 PM
 */
@Component @Validated
public class MutationResolver implements GraphQLMutationResolver {
	...
	/**
	 * 
	 * @param requestcfvalueInput
	 */
	public RequestCFValueTo createRequestCFValue(RequestCFValueInput requestcfvalueInput){
		return requestcfvalueService.createRequestCFValue(requestcfvalueInput);
	}
	...
	/**
	 * 
	 * @param idrequestcfvalue
	 */
	public int deleteRequestCFValue(int idrequestcfvalue){
		return requestcfvalueService.deleteRequestCFValue(idrequestcfvalue);
	}
	 ...
	 * @param requestcfvalueInput
	 */
	public RequestCFValueTo modifyRequestCFValue(RequestCFValueInput requestcfvalueInput){
		return requestcfvalueService.modifyRequestCFValue(requestcfvalueInput);
	}
	 ...
	 */
	@Autowired
	public MutationResolver(TraitClassService traitclassService, ServiceProviderService serviceproviderService, ServiceService serviceService, PurposeService purposeService, MarkerSynonymService markersynonymService, MarkerService markerService, DataFormatService dataformatService, WorkflowCFTypeService workflowcftypeService, AssayclassService assayclassService, TraitService traitService, WorkflowStatusService workflowstatusService, WorkflowStageService workflowstageService, WorkflowPhaseService workflowphaseService, WorkflowNodeCFService workflownodecfService, WorkflowNodeService workflownodeService, WorkflowInstanceService workflowinstanceService, WorkflowEventService workfloweventService, AssayGeneService assaygeneService, RequestCFValueService requestcfvalueService, WorkflowStatusTypeService workflowstatustypeService, TranslationService translationService, TenantService tenantService, StyleThemeService stylethemeService, SessionService sessionService, SeasonService seasonService, SchemeService schemeService, ServiceTypeService servicetypeService, RoleService roleService, TechnologyPlatformService technologyplatformService, CropService cropService, ComponentService componentService, AuthenticationTypeService authenticationtypeService, AuditLogsService auditlogsService, AttributesService attributesService, AlertRuleService alertruleService, CollaboratorService collaboratorService, RoleActionService roleactionService, HtmlTagService htmltagService, ProcessService processService, ProgramService programService, ProjectService projectService, RequestService requestService, UserService userService, VendorService vendorService, WorkflowService workflowService, PersonService personService, PermissionService permissionService, PartnerService partnerService, OrganizationService organizationService, ModuleService moduleService, MessageService messageService, PreferenceService preferenceService, ActionService actionService, DonorService donorService, DelegationService delegationService, CustomerService customerService, AlertService alertService, AddressService addressService, InstanceService instanceService, CountryService countryService, LanguageService languageService){
