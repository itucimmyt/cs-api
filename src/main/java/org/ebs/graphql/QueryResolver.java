...
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(ActionService actionService, PreferenceService preferenceService, ProcessService processService, AuditLogsService auditlogsService, DonorService donorService, LanguageService languageService, TranslationService translationService, HtmlTagService htmltagService, ThemeStyleService themestyleService, CountryService countryService, InstanceService instanceService, CollaboratorService collaboratorService, DelegationService delegationService, ModuleService moduleService, CustomerService customerService, WorkflowNodeService workflownodeService, PartnerService partnerService, AlertRuleService alertruleService, ComponentService componentService, MessageService messageService, OrganizationService organizationService, WorkflowService workflowService, SessionService sessionService, AuthenticationTypeService authenticationtypeService, AddressService addressService, RoleService roleService, PearsonService pearsonService, UserService userService, TenantService tenantService, AlertService alertService){
