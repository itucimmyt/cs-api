...
//  Created on:      27-Jul-2020 8:43:16 AM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 27-Jul-2020 8:43:16 AM
 */
@Component @Validated
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(TranslationService translationService, RoleService roleService, WorkflowEventService workfloweventService, WorkflowCFValueService workflowcfvalueService, WorkflowCFTypeService workflowcftypeService, WorkflowService workflowService, WorkflowNodeService workflownodeService, UserService userService, WorkflowNodeCFService workflownodecfService, TenantService tenantService, StyleThemeService stylethemeService, SessionService sessionService, SegmentService segmentService, SeasonService seasonService, TraitClassService traitclassService, VendorService vendorService, MarkerService markerService, TraitService traitService, TechnologyPlatformService technologyplatformService, ServiceTypeService servicetypeService, ServiceProviderService serviceproviderService, ServiceService serviceService, WorkflowInstanceService workflowinstanceService, MarkerSynonymService markersynonymService, RequestService requestService, DataFormatService dataformatService, AssayGeneService assaygeneService, AssayclassService assayclassService, WorkflowStatusService workflowstatusService, WorkflowStageService workflowstageService, WorkflowPhaseService workflowphaseService, PurposeService purposeService, AuditLogsService auditlogsService, RoleActionService roleactionService, DonorService donorService, DelegationService delegationService, CustomerService customerService, CropService cropService, EntityReferenceService entityreferenceService, AuthenticationTypeService authenticationtypeService, HtmlTagService htmltagService, AttributesService attributesService, AlertRuleService alertruleService, AlertService alertService, AddressService addressService, ActionService actionService, WorkflowStatusTypeService workflowstatustypeService, ComponentService componentService, OrganizationService organizationService, ProjectService projectService, ProgramService programService, ProcessService processService, PreferenceService preferenceService, PersonService personService, EmailTemplateService emailtemplateService, PartnerService partnerService, CountryService countryService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, NumberSequenceRuleService numbersequenceruleService, ModuleService moduleService, MessageService messageService, LanguageService languageService, InstanceService instanceService, PermissionService permissionService, CollaboratorService collaboratorService){
