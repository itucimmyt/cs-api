...
//  Created on:      10-Sep-2020 12:19:57 AM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 10-Sep-2020 12:19:57 AM
 */
@Component @Validated
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(ActionService actionService, CountryService countryService, WorkflowCFTypeService workflowcftypeService, WorkflowCFValueService workflowcfvalueService, WorkflowEventService workfloweventService, WorkflowInstanceService workflowinstanceService, VendorService vendorService, WorkflowNodeCFService workflownodecfService, UserService userService, AddressService addressService, AlertRuleService alertruleService, AuditLogsService auditlogsService, AuthenticationTypeService authenticationtypeService, CollaboratorService collaboratorService, ComponentService componentService, WorkflowNodeService workflownodeService, PreferenceService preferenceService, TraitService traitService, WorkflowStatusTypeService workflowstatustypeService, NumberSequenceRuleService numbersequenceruleService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, OrganizationService organizationService, WorkflowService workflowService, PersonService personService, AttributesService attributesService, ProcessService processService, SessionService sessionService, StyleThemeService stylethemeService, TeamService teamService, TenantService tenantService, TranslationService translationService, PartnerService partnerService, WorkflowPhaseService workflowphaseService, EmailTemplateService emailtemplateService, EntityReferenceService entityreferenceService, HtmlTagService htmltagService, InstanceService instanceService, LanguageService languageService, NotificationService notificationService, ModuleService moduleService, ProgramService programService, ProjectService projectService, RequestService requestService, RoleService roleService, RoleActionService roleactionService, DonorService donorService, SegmentService segmentService, WorkflowStatusService workflowstatusService, WorkflowStageService workflowstageService, CropService cropService, TraitClassService traitclassService, AlertService alertService, AssayGeneService assaygeneService, DataFormatService dataformatService, MarkerService markerService, MarkerSynonymService markersynonymService, PurposeService purposeService, ServiceService serviceService, ServiceProviderService serviceproviderService, ServiceTypeService servicetypeService, TechnologyPlatformService technologyplatformService, SeasonService seasonService, CustomerService customerService, AssayclassService assayclassService, DelegationService delegationService){
