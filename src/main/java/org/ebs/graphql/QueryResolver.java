...
public class QueryResolver implements GraphQLQueryResolver {
	...
	public Optional<RequestCFValueTo> findRequestCFValue(int requestcfvalueId){
		return this.requestcfvalueService.findRequestCFValue(requestcfvalueId);
	}
	 ...
	 * @param filters
	 */
	public Page<RequestCFValueTo> findRequestCFValueList(PageInput page, SortInput sort, List<FilterInput> filters){
		return this.requestcfvalueService.findRequestCFValues(page,sort,filters);
	}
	 ...
	 */
	@Autowired
	public QueryResolver(StyleThemeService stylethemeService, PersonService personService, WorkflowPhaseService workflowphaseService, WorkflowNodeCFService workflownodecfService, WorkflowNodeService workflownodeService, WorkflowInstanceService workflowinstanceService, WorkflowEventService workfloweventService, WorkflowCFTypeService workflowcftypeService, WorkflowService workflowService, VendorService vendorService, UserService userService, WorkflowStatusService workflowstatusService, TenantService tenantService, TraitClassService traitclassService, SessionService sessionService, SeasonService seasonService, SchemeService schemeService, RoleActionService roleactionService, RoleService roleService, RequestCFValueService requestcfvalueService, RequestService requestService, ProjectService projectService, ProgramService programService, ProcessService processService, PreferenceService preferenceService, TranslationService translationService, WorkflowStatusTypeService workflowstatustypeService, DonorService donorService, DelegationService delegationService, CustomerService customerService, CropService cropService, CountryService countryService, CollaboratorService collaboratorService, AuditLogsService auditlogsService, AttributesService attributesService, AlertRuleService alertruleService, AlertService alertService, WorkflowStageService workflowstageService, ActionService actionService, AuthenticationTypeService authenticationtypeService, TraitService traitService, TechnologyPlatformService technologyplatformService, ServiceTypeService servicetypeService, ServiceProviderService serviceproviderService, ServiceService serviceService, PurposeService purposeService, MarkerSynonymService markersynonymService, MarkerService markerService, DataFormatService dataformatService, AssayGeneService assaygeneService, AssayclassService assayclassService, AddressService addressService, PermissionService permissionService, PartnerService partnerService, OrganizationService organizationService, ModuleService moduleService, MessageService messageService, LanguageService languageService, InstanceService instanceService, HtmlTagService htmltagService, ComponentService componentService){
