...
//  Created on:      07-Aug-2020 3:01:03 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 07-Aug-2020 3:01:03 PM
 */
@Component @Validated
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(PersonService personService, RoleActionService roleactionService, RoleService roleService, RequestService requestService, ProjectService projectService, ProgramService programService, LanguageService languageService, WorkflowCFTypeService workflowcftypeService, SessionService sessionService, PartnerService partnerService, OrganizationService organizationService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, NumberSequenceRuleService numbersequenceruleService, ModuleService moduleService, MessageService messageService, ProcessService processService, VendorService vendorService, AssayclassService assayclassService, TraitClassService traitclassService, WorkflowStatusService workflowstatusService, WorkflowStageService workflowstageService, WorkflowPhaseService workflowphaseService, WorkflowNodeCFService workflownodecfService, SeasonService seasonService, WorkflowService workflowService, SegmentService segmentService, UserService userService, TranslationService translationService, TenantService tenantService, teamService teamService, StyleThemeService stylethemeService, PermissionService permissionService, WorkflowNodeService workflownodeService, MarkerSynonymService markersynonymService, ActionService actionService, WorkflowStatusTypeService workflowstatustypeService, TraitService traitService, TechnologyPlatformService technologyplatformService, ServiceTypeService servicetypeService, InstanceService instanceService, AddressService addressService, PreferenceService preferenceService, ServiceProviderService serviceproviderService, MarkerService markerService, DataFormatService dataformatService, AssayGeneService assaygeneService, WorkflowInstanceService workflowinstanceService, WorkflowEventService workfloweventService, WorkflowCFValueService workflowcfvalueService, ServiceService serviceService, CountryService countryService, EntityReferenceService entityreferenceService, EmailTemplateService emailtemplateService, DonorService donorService, DelegationService delegationService, CustomerService customerService, AlertService alertService, CropService cropService, HtmlTagService htmltagService, ComponentService componentService, CollaboratorService collaboratorService, AuthenticationTypeService authenticationtypeService, AuditLogsService auditlogsService, AttributesService attributesService, AlertRuleService alertruleService, PurposeService purposeService){
