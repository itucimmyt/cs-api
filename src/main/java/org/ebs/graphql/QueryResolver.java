...
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(WorkflowPhaseService workflowphaseService, UserService userService, DataFormatService dataformatService, AssayGeneService assaygeneService, AssayclassService assayclassService, TraitClassService traitclassService, MarkerSynonymService markersynonymService, WorkflowStageService workflowstageService, PurposeService purposeService, WorkflowNodeCFService workflownodecfService, WorkflowNodeService workflownodeService, WorkflowInstanceService workflowinstanceService, WorkflowEventService workfloweventService, WorkflowCFTypeService workflowcftypeService, ComponentService componentService, WorkflowStatusService workflowstatusService, ActionService actionService, CollaboratorService collaboratorService, AuthenticationTypeService authenticationtypeService, AuditLogsService auditlogsService, AttributesService attributesService, AlertRuleService alertruleService, MarkerService markerService, AddressService addressService, TranslationService translationService, WorkflowStatusTypeService workflowstatustypeService, TraitService traitService, TechnologyPlatformService technologyplatformService, ServiceTypeService servicetypeService, ServiceProviderService serviceproviderService, ServiceService serviceService, AlertService alertService, EntityReferenceService entityreferenceService, VendorService vendorService, NumberSequenceRuleService numbersequenceruleService, ModuleService moduleService, MessageService messageService, LanguageService languageService, OrganizationService organizationService, HtmlTagService htmltagService, PartnerService partnerService, EmailTemplateService emailtemplateService, DonorService donorService, DelegationService delegationService, CustomerService customerService, CropService cropService, CountryService countryService, InstanceService instanceService, RoleService roleService, TenantService tenantService, teamService teamService, StyleThemeService stylethemeService, SessionService sessionService, SegmentService segmentService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, RoleActionService roleactionService, WorkflowCFValueService workflowcfvalueService, RequestService requestService, ProjectService projectService, ProgramService programService, ProcessService processService, PreferenceService preferenceService, PersonService personService, SeasonService seasonService, WorkflowService workflowService){
