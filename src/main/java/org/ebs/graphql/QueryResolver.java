...
//  Created on:      07-Sep-2020 8:11:55 AM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 07-Sep-2020 8:11:55 AM
 */
@Component @Validated
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(OrganizationService organizationService, AssayclassService assayclassService, InstanceService instanceService, LanguageService languageService, NotificationService notificationService, ModuleService moduleService, EntityReferenceService entityreferenceService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, EmailTemplateService emailtemplateService, PartnerService partnerService, PersonService personService, PreferenceService preferenceService, ProcessService processService, ProjectService projectService, WorkflowStatusTypeService workflowstatustypeService, NumberSequenceRuleService numbersequenceruleService, CollaboratorService collaboratorService, ActionService actionService, AddressService addressService, AlertService alertService, AlertRuleService alertruleService, AttributesService attributesService, HtmlTagService htmltagService, AuthenticationTypeService authenticationtypeService, AssayGeneService assaygeneService, ComponentService componentService, CountryService countryService, CropService cropService, CustomerService customerService, DelegationService delegationService, DonorService donorService, AuditLogsService auditlogsService, WorkflowEventService workfloweventService, TraitClassService traitclassService, TranslationService translationService, UserService userService, VendorService vendorService, WorkflowService workflowService, TeamService teamService, WorkflowCFValueService workflowcfvalueService, StyleThemeService stylethemeService, WorkflowInstanceService workflowinstanceService, WorkflowNodeService workflownodeService, WorkflowNodeCFService workflownodecfService, WorkflowPhaseService workflowphaseService, WorkflowStageService workflowstageService, WorkflowStatusService workflowstatusService, WorkflowCFTypeService workflowcftypeService, TechnologyPlatformService technologyplatformService, DataFormatService dataformatService, MarkerService markerService, MarkerSynonymService markersynonymService, PurposeService purposeService, ServiceService serviceService, TenantService tenantService, ServiceTypeService servicetypeService, ProgramService programService, TraitService traitService, RoleService roleService, RoleActionService roleactionService, SeasonService seasonService, SegmentService segmentService, SessionService sessionService, ServiceProviderService serviceproviderService, RequestService requestService){
