...
//  Created on:      23-Jul-2020 10:47:01 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 23-Jul-2020 10:47:01 PM
 */
@Component @Validated
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(CustomerService customerService, RoleService roleService, WorkflowInstanceService workflowinstanceService, WorkflowEventService workfloweventService, WorkflowCFValueService workflowcfvalueService, WorkflowCFTypeService workflowcftypeService, WorkflowNodeCFService workflownodecfService, VendorService vendorService, WorkflowPhaseService workflowphaseService, TranslationService translationService, StyleThemeService stylethemeService, SessionService sessionService, SegmentService segmentService, SeasonService seasonService, RoleActionService roleactionService, WorkflowService workflowService, MarkerSynonymService markersynonymService, TraitClassService traitclassService, TraitService traitService, TechnologyPlatformService technologyplatformService, ServiceTypeService servicetypeService, ServiceProviderService serviceproviderService, WorkflowNodeService workflownodeService, PurposeService purposeService, TenantService tenantService, MarkerService markerService, DataFormatService dataformatService, AssayGeneService assaygeneService, AssayclassService assayclassService, WorkflowStatusService workflowstatusService, WorkflowStageService workflowstageService, ServiceService serviceService, LanguageService languageService, ActionService actionService, WorkflowStatusTypeService workflowstatustypeService, PartnerService partnerService, OrganizationService organizationService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, RequestService requestService, AddressService addressService, UserService userService, NumberSequenceRuleService numbersequenceruleService, InstanceService instanceService, HtmlTagService htmltagService, EntityReferenceService entityreferenceService, EmailTemplateService emailtemplateService, DonorService donorService, DelegationService delegationService, ModuleService moduleService, CountryService countryService, ProgramService programService, ProcessService processService, PreferenceService preferenceService, PersonService personService, PermissionService permissionService, AlertService alertService, CropService cropService, ProjectService projectService, ComponentService componentService, CollaboratorService collaboratorService, AuthenticationTypeService authenticationtypeService, AuditLogsService auditlogsService, AttributesService attributesService, AlertRuleService alertruleService, MessageService messageService){
