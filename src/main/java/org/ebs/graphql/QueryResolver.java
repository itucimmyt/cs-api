...
//  Created on:      13-Jul-2020 5:07:08 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 13-Jul-2020 5:07:08 PM
 */
@Component @Validated
public class QueryResolver implements GraphQLQueryResolver {
	 ...
	 */
	@Autowired
	public QueryResolver(HtmlTagService htmltagService, ProgramService programService, WorkflowPhaseService workflowphaseService, WorkflowStageService workflowstageService, WorkflowStatusService workflowstatusService, ActionService actionService, AddressService addressService, AlertService alertService, AlertRuleService alertruleService, AttributesService attributesService, AuditLogsService auditlogsService, WorkflowNodeService workflownodeService, EntityReferenceService entityreferenceService, WorkflowInstanceService workflowinstanceService, InstanceService instanceService, LanguageService languageService, MessageService messageService, ModuleService moduleService, NumberSequenceRuleService numbersequenceruleService, NumberSequenceRuleSegmentService numbersequencerulesegmentService, OrganizationService organizationService, PartnerService partnerService, PersonService personService, PreferenceService preferenceService, ProcessService processService, AuthenticationTypeService authenticationtypeService, SeasonService seasonService, WorkflowStatusTypeService workflowstatustypeService, CollaboratorService collaboratorService, ComponentService componentService, CropService cropService, DelegationService delegationService, DonorService donorService, EmailTemplateService emailtemplateService, ProjectService projectService, RequestService requestService, RoleService roleService, WorkflowNodeCFService workflownodecfService, SchemeService schemeService, CustomerService customerService, SegmentService segmentService, SessionService sessionService, StyleThemeService stylethemeService, TenantService tenantService, TranslationService translationService, UserService userService, VendorService vendorService, WorkflowService workflowService, WorkflowCFTypeService workflowcftypeService, WorkflowCFValueService workflowcfvalueService, WorkflowEventService workfloweventService, RoleActionService roleactionService, CountryService countryService){
