...
public class ModuleResolver implements GraphQLResolver<ModuleTo> {
	 ...
	 */
	@Autowired
	public ModuleResolver(ModuleRepository moduleRepository, ModuleService moduleService, TranslationRepository translationRepository, TranslationService translationService, ComponentRepository componentRepository, ComponentService componentService, ActionRepository actionRepository, ActionService actionService, WorkflowNodeRepository workflownodeRepository, WorkflowNodeService workflownodeService){
