...
@Service @Transactional(readOnly = true)
  class CountryServiceImpl implements CountryService {
	 ...
	 */
	@Autowired
	public CountryServiceImpl(VendorRepository vendorRepository, ConversionService converter, CountryRepository countryRepository){
	...
	public Set<VendorTo> findVendors(int countryId){
		return vendorRepository.findByCountryId(countryId).stream().map(e -> converter.convert(e,VendorTo.class)).collect(Collectors.toSet());
	}
