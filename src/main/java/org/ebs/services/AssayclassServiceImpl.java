...
@Service @Transactional(readOnly = true)
  class AssayclassServiceImpl implements AssayclassService {
	...
	public Set<TechnologyPlatformTo> findtechnologyplatforms(int assayclassId){
		return assayclassRepository.findById(assayclassId).get().getTechnologyplatforms().stream().map(e->converter.convert(e, TechnologyPlatformTo.class)).collect(Collectors.toSet());
	}
