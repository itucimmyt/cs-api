...
@Service @Transactional(readOnly = true)
  class ComponentServiceImpl implements ComponentService {
	 ...
	 */
	@Autowired
	public ComponentServiceImpl(HtmlTagRepository htmltagRepository, ModuleRepository moduleRepository, InstanceRepository instanceRepository, ConversionService converter, ComponentRepository componentRepository){
