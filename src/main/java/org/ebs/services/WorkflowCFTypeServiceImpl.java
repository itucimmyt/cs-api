...
@Service @Transactional(readOnly = true)
  class WorkflowCFTypeServiceImpl implements WorkflowCFTypeService {
	 ...
	 */
	@Autowired
	public WorkflowCFTypeServiceImpl(ConversionService converter, WorkflowCFTypeRepository workflowcftypeRepository, WorkflowNodeCFRepository workflownodecfRepository){
