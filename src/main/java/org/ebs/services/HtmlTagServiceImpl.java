...
//  Created on:      20-Aug-2020 1:05:46 PM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 20-Aug-2020 1:05:46 PM
 */
@Service @Transactional(readOnly = true)
  class HtmlTagServiceImpl implements HtmlTagService {
	 ...
	 */
	@Autowired
	public HtmlTagServiceImpl(WorkflowStageRepository workflowstageRepository, AttributesRepository attributesRepository, ConversionService converter, HtmlTagRepository htmltagRepository, WorkflowNodeCFRepository workflownodecfRepository, ModuleRepository moduleRepository, TranslationRepository translationRepository, AlertRepository alertRepository, WorkflowPhaseRepository workflowphaseRepository, WorkflowRepository workflowRepository, ComponentRepository componentRepository, MessageRepository messageRepository, WorkflowNodeRepository workflownodeRepository){
