...
//  Created on:      27-Jul-2020 8:42:36 AM
 ...
 * @author EBRIONES
 * @version 1.0
 * @created 27-Jul-2020 8:42:36 AM
 */
@Service @Transactional(readOnly = true)
  class HtmlTagServiceImpl implements HtmlTagService {
	 ...
	 */
	@Autowired
	public HtmlTagServiceImpl(AttributesRepository attributesRepository, WorkflowNodeRepository workflownodeRepository, WorkflowRepository workflowRepository, WorkflowPhaseRepository workflowphaseRepository, WorkflowStageRepository workflowstageRepository, MessageRepository messageRepository, ModuleRepository moduleRepository, AlertRepository alertRepository, TranslationRepository translationRepository, ConversionService converter, HtmlTagRepository htmltagRepository, WorkflowNodeCFRepository workflownodecfRepository, ComponentRepository componentRepository){
