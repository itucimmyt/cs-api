...
@Service @Transactional(readOnly = true)
  class AttributesServiceImpl implements AttributesService {
	 ...
	 */
	@Autowired
	public AttributesServiceImpl(AttributesRepository attributesRepository, EntityReferenceRepository entityreferenceRepository, TranslationRepository translationRepository, ConversionService converter){
