...
@Service @Transactional(readOnly = true)
  class WorkflowStatusTypeServiceImpl implements WorkflowStatusTypeService {
	 ...
	 */
	@Autowired
	public WorkflowStatusTypeServiceImpl(WorkflowStatusTypeRepository workflowstatustypeRepository, WorkflowStatusRepository workflowstatusRepository, ConversionService converter){
