...
@Service @Transactional(readOnly = true)
  class CropServiceImpl implements CropService {
	 ...
	 */
	@Autowired
	public CropServiceImpl(ProgramRepository programRepository, ConversionService converter, CropRepository cropRepository){
	...
	public Optional<CropTo> findCrop(int cropId){
		if(cropId <1) 
		 ...
		 return cropRepository.findById(cropId).filter(r -> !r.isDeleted()).map(r -> converter.convert(r,CropTo.class));
	}
