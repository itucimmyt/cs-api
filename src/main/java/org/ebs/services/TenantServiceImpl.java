...
@Service @Transactional(readOnly = true)
  class TenantServiceImpl implements TenantService {
	 ...
	 */
	@Autowired
	public TenantServiceImpl(PersonRepository personRepository, TenantRepository tenantRepository, ConversionService converter, EmailTemplateRepository emailtemplateRepository, UserRepository userRepository, InstanceRepository instanceRepository, WorkflowRepository workflowRepository, OrganizationRepository organizationRepository, NumberSequenceRuleRepository numbersequenceruleRepository, CustomerRepository customerRepository){
