...
@Service @Transactional(readOnly = true)
  class WorkflowNodeCFServiceImpl implements WorkflowNodeCFService {
	 ...
	 */
	@Autowired
	public WorkflowNodeCFServiceImpl(WorkflowNodeRepository workflownodeRepository, WorkflowCFTypeRepository workflowcftypeRepository, RequestCFValueRepository requestcfvalueRepository, ConversionService converter, WorkflowNodeCFRepository workflownodecfRepository){
