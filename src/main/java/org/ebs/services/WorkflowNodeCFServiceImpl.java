...
@Service @Transactional(readOnly = true)
  class WorkflowNodeCFServiceImpl implements WorkflowNodeCFService {
	 ...
	 */
	@Autowired
	public WorkflowNodeCFServiceImpl(HtmlTagRepository htmltagRepository, WorkflowNodeCFRepository workflownodecfRepository, ConversionService converter, WorkflowCFValueRepository workflowcfvalueRepository, WorkflowCFTypeRepository workflowcftypeRepository, EntityReferenceRepository entityreferenceRepository, WorkflowNodeRepository workflownodeRepository){
