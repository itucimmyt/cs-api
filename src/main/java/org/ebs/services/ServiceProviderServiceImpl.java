...
@Service @Transactional(readOnly = true)
  class ServiceProviderServiceImpl implements ServiceProviderService {
	...
	public Set<RequestTo> findRequests(int serviceproviderId){
		return requestRepository.findByServiceproviderId(serviceproviderId).stream().map(e -> converter.convert(e,RequestTo.class)).collect(Collectors.toSet());
	}
	 ...
	 */
	@Autowired
	public ServiceProviderServiceImpl(RequestRepository requestRepository, ServiceTypeRepository servicetypeRepository, ConversionService converter, ServiceProviderRepository serviceproviderRepository){
