...
@Service @Transactional(readOnly = true)
  class AlertServiceImpl implements AlertService {
	 ...
	 */
	@Autowired
	public AlertServiceImpl(AlertRepository alertRepository, PreferenceRepository preferenceRepository, TranslationRepository translationRepository, AlertRuleRepository alertruleRepository, ConversionService converter){
