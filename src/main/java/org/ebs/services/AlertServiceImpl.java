...
@Service @Transactional(readOnly = true)
  class AlertServiceImpl implements AlertService {
	 ...
	 */
	@Autowired
	public AlertServiceImpl(PreferenceRepository preferenceRepository, TranslationRepository translationRepository, AlertRuleRepository alertruleRepository, ConversionService converter, AlertRepository alertRepository){
	...
	public Set<TranslationTo> findTranslations(int alertId){
		return translationRepository.findByAlertId(alertId).stream().map(e -> converter.convert(e,TranslationTo.class)).collect(Collectors.toSet());
	}
