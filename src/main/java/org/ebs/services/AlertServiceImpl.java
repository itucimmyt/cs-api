...
@Service @Transactional(readOnly = true)
  class AlertServiceImpl implements AlertService {
	 ...
	 */
	@Autowired
	public AlertServiceImpl(HtmlTagRepository htmltagRepository, PreferenceRepository preferenceRepository, AlertRuleRepository alertruleRepository, ConversionService converter, AlertRepository alertRepository){
