...
@Service @Transactional(readOnly = true)
  class ModuleServiceImpl implements ModuleService {
	 ...
	 */
	@Autowired
	public ModuleServiceImpl(WorkflowNodeRepository workflownodeRepository, ModuleRepository moduleRepository, ConversionService converter, ActionRepository actionRepository, ComponentRepository componentRepository, TranslationRepository translationRepository){
